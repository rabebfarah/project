...
export const RECIPE_REVIEW_SAVE_REQUEST = 'RECIPE_REVIEW_SAVE_REQUEST';
export const RECIPE_REVIEW_SAVE_SUCCESS = 'RECIPE_REVIEW_SAVE_SUCCESS';
export const RECIPE_REVIEW_SAVE_FAIL = 'RECIPE_REVIEW_SAVE_FAIL';
export const RECIPE_REVIEW_SAVE_RESET = 'RECIPE_REVIEW_SAVE_RESET';
